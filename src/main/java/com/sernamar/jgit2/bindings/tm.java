...
public class tm {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        git2.C_INT.withName("tm_sec"),
        git2.C_INT.withName("tm_min"),
        git2.C_INT.withName("tm_hour"),
        git2.C_INT.withName("tm_mday"),
        git2.C_INT.withName("tm_mon"),
        git2.C_INT.withName("tm_year"),
        git2.C_INT.withName("tm_wday"),
        git2.C_INT.withName("tm_yday"),
        git2.C_INT.withName("tm_isdst"),
        MemoryLayout.paddingLayout(4),
        git2.C_LONG.withName("tm_gmtoff"),
        git2.C_POINTER.withName("tm_zone")
    ).withName("tm");
