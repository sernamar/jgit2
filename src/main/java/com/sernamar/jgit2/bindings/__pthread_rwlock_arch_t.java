...
public class __pthread_rwlock_arch_t {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        git2.C_INT.withName("__readers"),
        git2.C_INT.withName("__writers"),
        git2.C_INT.withName("__wrphase_futex"),
        git2.C_INT.withName("__writers_futex"),
        git2.C_INT.withName("__pad3"),
        git2.C_INT.withName("__pad4"),
        git2.C_INT.withName("__cur_writer"),
        git2.C_INT.withName("__shared"),
        git2.C_CHAR.withName("__rwelision"),
        MemoryLayout.sequenceLayout(7, git2.C_CHAR).withName("__pad1"),
        git2.C_LONG.withName("__pad2"),
        git2.C_INT.withName("__flags"),
