...
public class drand48_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(3, git2.C_SHORT).withName("__x"),
        MemoryLayout.sequenceLayout(3, git2.C_SHORT).withName("__old_x"),
        git2.C_SHORT.withName("__c"),
        git2.C_SHORT.withName("__init"),
        git2.C_LONG_LONG.withName("__a")
