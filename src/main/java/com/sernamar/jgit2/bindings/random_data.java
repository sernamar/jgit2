...
public class random_data {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        git2.C_POINTER.withName("fptr"),
        git2.C_POINTER.withName("rptr"),
        git2.C_POINTER.withName("state"),
        git2.C_INT.withName("rand_type"),
        git2.C_INT.withName("rand_deg"),
        git2.C_INT.withName("rand_sep"),
        MemoryLayout.paddingLayout(4),
        git2.C_POINTER.withName("end_ptr")
