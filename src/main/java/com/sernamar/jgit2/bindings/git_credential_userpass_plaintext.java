 ...
 * }
 */
public class git_credential_userpass_plaintext {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        git2.C_POINTER.withName("password")
    ).withName("git_credential_userpass_plaintext");
    ...
    private static final long password$OFFSET = 24;
