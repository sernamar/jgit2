...
public class __pthread_mutex_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        git2.C_INT.withName("__lock"),
        git2.C_INT.withName("__count"),
        git2.C_INT.withName("__owner"),
        git2.C_INT.withName("__nusers"),
        git2.C_INT.withName("__kind"),
        git2.C_SHORT.withName("__spins"),
        git2.C_SHORT.withName("__elision"),
