...
public class __locale_struct {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        MemoryLayout.sequenceLayout(13, git2.C_POINTER).withName("__locales"),
        git2.C_POINTER.withName("__ctype_b"),
        git2.C_POINTER.withName("__ctype_tolower"),
        git2.C_POINTER.withName("__ctype_toupper"),
        MemoryLayout.sequenceLayout(13, git2.C_POINTER).withName("__names")
