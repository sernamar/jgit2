 ...
 * }
 */
public class git_cred_acquire_cb {
    ...
    private static final MethodHandle UP$MH = git2.upcallHandle(git_cred_acquire_cb.Function.class, "apply", $DESC);

    /**
     * Allocates a new upcall stub, whose implementation is defined by {@code fi}.
     * The lifetime of the returned segment is managed by {@code arena}
     */
    public static MemorySegment allocate(git_cred_acquire_cb.Function fi, Arena arena) {
