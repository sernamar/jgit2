...
public class __pthread_cond_s {
    ...
    private static final GroupLayout $LAYOUT = MemoryLayout.structLayout(
        ...
        MemoryLayout.sequenceLayout(2, git2.C_INT).withName("__g_refs"),
        MemoryLayout.sequenceLayout(2, git2.C_INT).withName("__g_size"),
        git2.C_INT.withName("__g1_orig_size"),
        git2.C_INT.withName("__wrefs"),
        MemoryLayout.sequenceLayout(2, git2.C_INT).withName("__g_signals")
